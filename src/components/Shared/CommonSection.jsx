...
const CommonSection = ({ backgroundImage,buttonText,title,description,text,width,height,borderRadius,bottom,left,bg,divTitle,fontSize,textColor,padding,paragraph,opacity,paragraphWidth,marginTop,pText,icon }) => {
  return (
    <div>
      <div className="my-16 md:mt-[160px] flex flex-col lg:flex-row gap-8 md:gap-[60px]">
      <div>
      ...
      <div className="bg-cover bg-center relative w-full lg:w-[560px] h-[400px] lg:h-[415px] rounded-md md:rounded-[32px]"
        style={{
      ...
      >
        <div className="absolute hidden lg:flex" style={{
            ...
            <div style={{
              ...
              {icon && <img src={icon} alt="" className="absolute right-[-3px] bottom-[-18px]"/>}
                </div>
            </div>
        </div>
      </div>
